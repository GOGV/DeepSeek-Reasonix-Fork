...
// replay, role-setting completion receipts, and startup config-warning delivery
// add small always-available contracts. The expanded contract remains tightly
// bounded while the gzip startup budgets stay flat.
