...
Fork builds tag the upstream release with build metadata: `v<upstream>+fork.<build-date>.<active-fix-count>` (e.g. `v1.20.0+fork.2026.08.06.2`).
...
| **reasonix** (anonymous) | [**HUQIANTAO**](https://github.com/HUQIANTAO) | [**GTC2080**](https://github.com/GTC2080) | [**mchenziyi**](https://github.com/mchenziyi) |
| [**Li-Charles-One**](https://github.com/Li-Charles-One) | **merge-order-check** (anonymous) | [**light-front-theory**](https://github.com/light-front-theory) | **Yan Li** (anonymous) |
| [**github-actions\[bot\]**](https://github.com/apps/github-actions) | [**eghrhegpe**](https://github.com/eghrhegpe) | **wufengfan** (anonymous) | [**Bernardxu123**](https://github.com/Bernardxu123) |
| [**HaoyueQin**](https://github.com/HaoyueQin) | [**CVEngineer66**](https://github.com/CVEngineer66) | [**dependabot\[bot\]**](https://github.com/apps/dependabot) | [**JesonChou**](https://github.com/JesonChou) |
