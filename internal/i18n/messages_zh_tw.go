...
var ChineseTraditional = Messages{
	...
	WorkModeListHeaderFmt:        "角色設定（目前：%s）",
	...
	WorkModeSwitchUnavailable:    "本會話不支援切換角色設定",
	WorkModeSwitchBusy:           "請先完成或取消目前工作，再切換角色設定",
	WorkModeAlreadyOnFmt:         "目前已經是 %s 角色設定",
	WorkModeSwitchingFmt:         "正在切換到 %s 角色設定…",
	WorkModeSwitchedFmt:          "已切換到 %s 角色設定（後續回合生效，不重建會話）",
