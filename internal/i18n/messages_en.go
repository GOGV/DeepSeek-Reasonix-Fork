...
var English = Messages{
	...
	CmdWorkMode:         "switch role setting",
	...
	WorkModeStatusFmt:            "role %s",
	WorkModeListHeaderFmt:        "role settings (current: %s)",
	...
	WorkModeSwitchUnavailable:    "role-setting switching is unavailable in this session",
	WorkModeSwitchBusy:           "finish or cancel active work before switching role settings",
	WorkModeAlreadyOnFmt:         "role setting is already %s",
	WorkModeSwitchingFmt:         "switching role setting to %s…",
	WorkModeSwitchedFmt:          "role setting switched to %s (applies to subsequent turns; no session rebuild)",
