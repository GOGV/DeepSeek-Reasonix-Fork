...
var Chinese = Messages{
	...
	WorkModeStatusFmt:            "角色 %s",
	WorkModeListHeaderFmt:        "角色设定（当前：%s）",
	...
	WorkModeSwitchUnavailable:    "本会话不支持切换角色设定",
	WorkModeSwitchBusy:           "请先完成或取消当前工作，再切换角色设定",
	WorkModeAlreadyOnFmt:         "当前已经是 %s 角色设定",
	WorkModeSwitchingFmt:         "正在切换到 %s 角色设定…",
	WorkModeSwitchedFmt:          "已切换到 %s 角色设定（后续回合生效，不重建会话）",
