...
make_fixture() {
  ...
  printf 'v2.13.0\n' > "$fixture/.wails-version"
  printf 'github.com/wailsapp/wails/v2 v2.13.0\n' > "$fixture/desktop/go.mod"
...
printf 'github.com/wailsapp/wails/v2 v2.14.0\n' > "$fixture/desktop/go.mod"
...
grep -Fq 'Wails CLI v2.12.0 does not match .wails-version v2.13.0' <<<"$output" || {
